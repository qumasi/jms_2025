        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#"><i class="bi bi-folder-fill me-1"></i> Documents</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="bi bi-calendar-event me-1"></i> Cases</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="bi bi-people-fill me-1"></i> Users</a>
                    </li>
                </ul>
                ...
                <div class="dropdown">
                    <a href="#" class="link-light text-decoration-none dropdown-toggle" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="col-md-3 col-lg-2 sidebar py-3">
                <div class="list-group list-group-flush">
                    <a href="#" class="list-group-item list-group-item-action active" aria-current="true">
                        <i class="bi bi-grid-1x2-fill me-2"></i> Document Dashboard
                    </a>
                ...
                <div class="mt-4 px-3">
                    <h6 class="text-uppercase small fw-bold">Categories</h6>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="category1" checked>
                        <label class="form-check-label w-100" for="category1">Legal Petitions</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="category2" checked>
                        <label class="form-check-label w-100" for="category2">Evidence Files</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="category3" checked>
                        <label class="form-check-label w-100" for="category3">Court Decisions</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="category4">
                        <label class="form-check-label w-100" for="category4">Witness Statements</label>
                    </div>
                </div>

                <div class="mt-4 px-3">
                    <h6 class="text-uppercase small fw-bold">Storage</h6>
            ...
            <div class="col-md-9 col-lg-10 py-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <h2 class="h4 mb-0">Document Management</h2>
                    </div>
                    <div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        ...
                                        <h3 class="card-title mb-0">47</h3>
                                    </div>
                                    <div class="flex-shrink-0">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        ...
                                        <h3 class="card-title mb-0">892</h3>
                                    </div>
                                    <div class="flex-shrink-0">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        <p class="text-muted small mb-1">Shared</p>
                                        <h3 class="card-title mb-0">315</h3>
                                    </div>
                                    <div class="flex-shrink-0">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                        <div class="card document-card h-100 border-0 shadow-sm">
                            <div class="card-body">
                                ...
                                <h6 class="card-title">Legal Petition - Case #2023-4876</h6>
                                <p class="card-text small text-muted">Submitted by: Ahmed Hassan</p>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    <div class="bg-warning bg-opacity-10 p-2 rounded">
                                        <i class="bi bi-file-pdf-fill text-warning fs-4"></i>
                                    </div>
                                    <div class="dropdown">
                                        <button class="btn btn-sm btn-link text-muted" type="button" data-bs-toggle="dropdown">
                                            <i class="bi bi-three-dots-vertical"></i>
                                ...
                                <h6 class="card-title">Evidence Document - Photos</h6>
                                <p class="card-text small text-muted">Submitted by: Police Dept.</p>
                                <div class="d-flex justify-content-between align-items-center mt-3">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    <div class="bg-info bg-opacity-10 p-2 rounded">
                                        <i class="bi bi-file-word-fill text-info fs-4"></i>
                                    </div>
                                    <div class="dropdown">
                                        <button class="btn btn-sm btn-link text-muted" type="button" data-bs-toggle="dropdown">
                                            <i class="bi bi-three-dots-vertical"></i>
                                ...
                                <h6 class="card-title">Witness Statement - Case #2023-5123</h6>
                                <p class="card-text small text-muted">Submitted by: Sara Mohammed</p>
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <span class="badge bg-success status-badge">Verified</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                        <div class="card document-card h-100 border-0 shadow-sm">
                            <div class="card-body">
                                ...
                                <h6 class="card-title">Financial Records - Case #2023-4982</h6>
                                <p class="card-text small text-muted">Submitted by: Finance Dept.</p>
                                <div class="d-flex justify-content-between align-items-center mt-3">
